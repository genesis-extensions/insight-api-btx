...
BlockController.prototype.getBlockReward = function(height) {
  ...
  if (self.node.services.bitcoind.height % (1440 * 7 * 4 * 12) == 0) { // TODO modulo
    ...
    subsidy = new BN(1000 / 100) // * 7 super , *7*4 mega, *7*4*12 ultra. //todo define block with those
  }
  ...
  // Subsidy is cut in half every 210000 blocks which will occur approximately every 2 years.
